App = {
  ...
  getCurrentPhase: function () {
    App.contracts.BlindAuction.deployed()
  ...
  handleWinner: function () {
    ...
    App.contracts.BlindAuction.deployed()
      ...
      .then(function (res) {
        ...
        toastr.info(
          "Highest bid is " + highestBid + " ETH <br>" + "Winner is " + winner,
          "",
  ...
  showNotification: function (phase) {
    ...
    toastr.info(phaseText, "", {
      iconClass: "toast-info notification" + phaseId,
    });
  },
};
